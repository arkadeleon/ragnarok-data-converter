...
EFFECT.EF_EF_C_MAKER = 1060
EFFECT.EF_QUAGMIRE_MINI = 1161
EFFECT.EF_LORD_MINI	= 1162
EFFECT.EF_METEORSTORM_MINI = 1163


-- 챔피온 몬스터 추가

tbl = {
[3626] = { MonsterSize = 2.0, MonsterEff ={ EFFECT.EF_NONE,}, },
[3636] =	{	MonsterSize  = 0.7,	MonsterEff   = {EFFECT.EF_BOTTOM_BARRIER,},    },
[3969] =	{	MonsterSize  = 2.5,		MonsterEff   = { EFFECT.EF_NONE,},			},	-- 악몽의지터벅 신규 추가 몬스터
[3970] =	{	MonsterSize  = 2.5,		MonsterEff   = { EFFECT.EF_HASTEUP,},			},	-- 악몽의지터벅 신규 추가 몬스터
[3910] =	{	MonsterSize  = 1.8,		MonsterEff   = { EFFECT.EF_MAGIC_FLOOR,},			},	-- X주년이벤트
[3911] =	{	MonsterSize  = 1.0,		MonsterEff   = { EFFECT.EF_GRAYBODY,},			},	-- X주년이벤트
[3912] =	{	MonsterSize  = 1.0,		MonsterEff   = { EFFECT.EF_GRAYBODY,},			},	-- X주년이벤트
[3913] =	{	MonsterSize  = 1.0,		MonsterEff   = { EFFECT.EF_GRAYBODY,},			},	-- X주년이벤트
[3914] =	{	MonsterSize  = 1.0,		MonsterEff   = { EFFECT.EF_GRAYBODY,},			},	-- X주년이벤트
[3915] =	{	MonsterSize  = 1.8,		MonsterEff   = { EFFECT.EF_GLOW4,},			},	-- X주년이벤트

--		[1002] =
--		    {
--			MonsterSize  = 1.7,
--			MonsterEff   = { EFFECT.EF_LEVEL99, EFFECT.EF_ANGEL, },
--		    },
		[502] =
		    {
			MonsterSize  = 1.2,
			MonsterEff   = { EFFECT.EF_DUSTSTORM, EFFECT.EF_EL_GUST, },
		    },
	}
