--==========================================
-- filename : jobName_F.lub
-- author : tei2000
-- created : January 5, 2010
-- descript : jobName 테스트용
-- version : 1.0.0
--==========================================
...
function 	GetJobString ( jobID )
	for k, v in pairs ( jobtbl ) do
		if ( v == jobID ) then
			--TraceValue ( string.format ( "%s, %d", k, v ) ) ;
			return k
		end
	end
	return ""
...
--===============================================
-- function : GetPetJTID_by_PetEggITID
-- returns : int
--===============================================
