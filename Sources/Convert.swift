...
struct Convert: ParsableCommand {
    ...
    func convertItemInfo() throws {
        ...
        try converter.convert(from: .lua(input, "iteminfo_new.lub"), to: output, for: .zhHant, encoding: .utf8)
    }
    ...
    func convertMapInfo() throws {
        ...
        try converter.convert(from: .txt(input), to: output, for: .it)
        try converter.convert(from: .txt(input), to: output, for: .ja)
        try converter.convert(from: .lua(input, "mapInfo_true.lub"), to: output, for: .ko)
        try converter.convert(from: .lua(input, "mapInfo.lub"), to: output, for: .ptBR)
        try converter.convert(from: .txt(input), to: output, for: .ru)
        ...
        try converter.convert(from: .lua(input, "mapInfo.lub"), to: output, for: .zhHant)
    }
}
